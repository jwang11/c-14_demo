/*
  ...
  i.e. it takes a function as input and returns a new function Object as an 
  output with with one or more of the arguments of passed function bound or rearranged.

  $g++ -o std_bind std_bind.cpp --std=c++11
*/
#include <memory>
#include <functional>
#include <iostream>
